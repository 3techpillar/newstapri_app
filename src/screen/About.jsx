      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.paragraph}>
            Welcome to <Text onPress={() => navigation.navigate("Home")}>
              <Text style={styles.bold}>Newstapri</Text> </Text>, where excellence and credibility define our approach to journalism.
